...
firefox.add_argument('--allow-running-insecure-content')
firefox.add_argument('--ignore-certificate-errors')
firefox.add_argument('--hide-scrollbars')
...
driver=webdriver.Firefox(options=firefox,executable_path=r'./driver/geckodriver')#FOR LINUX
import re
